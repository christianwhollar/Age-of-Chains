...
if __name__ == "__main__":
    ...
    # Demonstrate usage
    python_file = PythonFile("test_python_file")
    python_file.make_file()
    python_file.append_file("Test python file")

    text_file = TextFile("test_text_file")
    text_file.make_file()
    text_file.append_file("Test text file")

    print(f"Files in current directory with .py extension: {python_file.list_files()}")
    print(f"Files in current directory with .txt extension: {text_file.list_files()}")
